import "./projects.css";
import animationData from "../assets/projectanimation.json";
import Lottie from "lottie-react";

const Projects = () => {
  return (
    <div className="lg:h-screen bg-[#d4ed6d] overflow-hidden relative">
      ...
      <div className="  max-w-[80%] mx-auto flex md:flex-row flex-col lg:justify-between justify-evenly h-[90%] lg:h-[80vh] items-center  ">
        <div className="card">
          ...
          <div className="card__descr-wrapper">
            ...
            <p className="card__descr">
              ...
              blanditiis nemo fugit autem possimus, magnam consequatur sint
              esse.
            </p>
            <div className="card__links">
              <div className=" flex flex-col items-center group ">
                ...
                <a className="link group-hover:underline" href="#">
                  Preview
                </a>
              </div>
              <div className="flex flex-col items-center group">
